...
class User extends React.Component{
    ...
    render(){
        return(
            <React.Fragment>
                <div>
                    <div className=' u-section-1 border-top border-bottom shadow-sm p-3 mb-5   bg-secondary'>
                        <div className='d-flex justify-content-center mb-4 headerUser rounded-bottom'>
                            <h1 className='text-light'>User Datalies</h1>
                         </div>
                            <div>
                                <span className='fw-normal d-flex flex-column bd-highlight mb-3 text-light'>Full Name: {this.props.fullname} </span>
                                <span className='fw-normal d-flex flex-column bd-highlight mb-3 text-light'>Email: {this.props.email}</span>   
